...
To save complexity, we represent a complex number by its real- and imarinary-parts.
...
{
\I Given are \m{\M {P} \in \MB {C} ^{N_Y^2 \D N_H^2}}, \m {\V {y} \in \MB {C} ^{N_Y^2}}, \m{\g _{\Ss {DS}} > 0}.
Let \m {\T {\V {y}}} and \m {\T {\M {P}}} respectively be their real representation.
...
%
\NC \Hat{\V {g}}
\LA \NC \MC{R} ^{-1} \SB {\Hat{\V {x}} _{\SB {0 : 2N_H^2-1}}} \NR
%
\NC \Hat {\M {H}}

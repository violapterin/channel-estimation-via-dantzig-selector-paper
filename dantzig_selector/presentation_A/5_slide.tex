...
\I Analogous to original DS proof, we bound the expected square error, and the successful probability is also bounded by a constant explicit depending on system parameters \m {s} and \m{L}
}
% % % % % % % % % % % % % % % % % % % % % % % % % %
\Frame {Future Work}
{

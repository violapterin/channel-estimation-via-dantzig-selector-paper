...
Accordingly, the corresponding definition of real representation of matrices is valid, once we call the ring representation of complex numbers.
...
Not all matrices in \m {\MB {M}_{\MB {R}} \SB {2M_1, 2M_2}} are images, but we do not need the inverse function.
}
...
\externalfigure[sim_1_abs.png]
\externalfigure[sim_1_rel.png]

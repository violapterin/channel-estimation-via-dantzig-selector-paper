...
\stopcases \NR[+]
\NC m_1 
= \NC 0, 1, 2, \dots, M_1 -1 \NR
\NC m_2 
= \NC 0, 1, 2, \dots, M_2 -1 \NR
}
...
= \NC \g \NR[+]
\NC i 
= \NC N_h, N_h +1, N_h +2, \dots, 2N_h -1 \NR
}
...
\NC \MC i =0, 1, 2, \dots, 2N_h -1 \NR
\stopcases \NR[+]
}
\item Extract
\Disp{
\NC \Hat{\T{\V{g}}} =\NC \Hat{\V{x}} \DB {0 : 2N_h-1} \NR[+]
}
\item Convert 
\Disp{
...
\item Calculate
\Disp {
\NC \Hat {G} =\NC \Rm {vec}^{-1} \SB {\Hat {g}} \NR[+]
}
\item Calculate
\Disp {

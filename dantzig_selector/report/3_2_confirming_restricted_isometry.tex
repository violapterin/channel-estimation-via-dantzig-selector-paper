...
{Definition}
{
To make expressions more compact, introduce the indication function \m {\i_{a_0, \ldots, a_{M-1}}:\; \MB {N}^{\MB {N}} \mapsto \CB {0, 1}}, so that, for some injective \m {\s:\; \CB {0, \ldots, N-1} \mapsto \CB {0, \ldots, M-1}},
\Disp {

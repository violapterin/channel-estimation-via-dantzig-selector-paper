...
\NC = \NC \i_4 \SB {n_H, n_H', n_H'', n_H'''} \D \i_4 \SB {n_Y, n_Y', n_Y'', n_Y'''} \D N_R M_{R,4} M_{B,4} \NR
\NC \NC \FourQ
+ \i_2 \SB {n_H, n_H''} \i_2 \SB {n_H', n_H'''}
\i_2 \SB {n_Y, n_Y''} \i_2 \SB {n_Y', n_Y'''}
\D N_R^2 M_{R,2}^2 M_{B,2}^2 \NR
\NC \NC \FourQ
+ \i_2 \SB {n_H, n_H'''} \i_2 \SB {n_H', n_H''}
\i_2 \SB {n_Y, n_Y'''} \i_2 \SB {n_Y, n_Y''}
\D N_R^2 M_{R,2}^2 M_{B,2}^2 \NR[+]
...
\NC = \NC \i_2 \SB {n_y, n_y'} \D \i_2 \SB {n_h, n_h'} \D N_R^2 M_{B,2}^2 M_{R,2}^2 \NR[+]
}
}
And
\Result
...
\NC = \NC
\i_4 \SB {n_y, n_y', n_y'', n_y'''} \D \i_4 \SB {n_h, n_h', n_h'', n_h'''} \D N_R^2 M_{R,4}^2 M_{B,4}^2 \NR
\NC \NC \FourQ
+ \i_2 \SB {n_y, n_y''} \i_2 \SB {n_y', n_y'''}
\i_2 \SB {n_h, n_h''} \i_2 \SB {n_h', n_h'''} \D N_R^4 M_{R,2}^4 M_{B,2}^4 \NR
\NC \NC \FourQ
+ \i_2 \SB {n_y, n_y'''} \i_2 \SB {n_y', n_y''}
\i_2 \SB {n_h, n_h'''} \i_2 \SB {n_h, n_h''} \D N_R^4 M_{R,2}^4 M_{B,2}^4 \NR[+]
}
...
\NC = \NC
N_R^2 M_{B,2}^2 M_{R,2}^2
\sum_{n_y =0}^{N_y-1}
\sum_{n_h, n_h' =0}^{N_h-1}
\i_2 \SB {n_h, n_h'} \D \V{u} \DB{n_h} \V{u} ^\ast \DB{n_h'} \NR
\NC = \NC
N_R^2 M_{B,2}^2 M_{R,2}^2 N_y \D \VNm {\V{u}} _2 ^2 \NR[+]
}
Thus, we may set
\Disp{
\NC \l_B
...
\NC = \NC
  ...
  \sum_{n_h, n_h', n_h'', n_h''' =0}^{N_h-1}
\Bigg(
\i_4 \SB {n_y, n_y'} \D \i_4 \SB {n_h, n_h', n_h'', n_h'''} \D N_R^2 M_{R,4}^2 M_{B,4}^2 \NR
\NC \NC \FourQ
+ \i_2 \SB {n_h, n_h''} \i_2 \SB {n_h', n_h'''} \D N_R^4 M_{R,2}^4 M_{B,2}^4 \NR
\NC \NC \FourQ
+ \i_2 \SB {n_y, n_y'}
\i_2 \SB {n_h, n_h'''} \i_2 \SB {n_h, n_h''} \D N_R^4 M_{R,2}^4 M_{B,2}^4
\Bigg) \NR
\NC \NC \SixQ
  \V{u} \DB{n_h} \V{u} \DB{n_h'} ^\ast
  \V{u} \DB{n_h''} \V{u} \DB{n_h'''} ^\ast \NR

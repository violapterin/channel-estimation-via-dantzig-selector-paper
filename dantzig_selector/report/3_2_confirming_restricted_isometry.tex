...
+\sum_{k=5}^\infty \F{s_{+} ^{k/2}} {k!}
  \Gamma \SB {\F{k}{4} +1} ^4 N_Y^{k} N_R^{k} \NR[+]
}
...
We would see that we must require \m {C \SB{s} < 1} for the series to converge.
...
\NC \NC \F{1}{c_0} \sum_{k=5}^\infty \F{s_{+} ^{k/2}} {k!}
  ...
  \VNm {\V{u}} _2 ^k \NR
%
\NC \leq \NC \int _{4} ^{\infty} C \SB {s} ^x x ^{3/2} \Ss {d} x \NR
%
\NC \leq \NC \F{1} {\log C}
\RB {
  \lim_{x \to \infty} C ^x x ^{3/2} -8 C ^4
  -\F{3}{2} \int _{4} ^{\infty} C ^x x ^{1/2} \Ss {d} x
} \NR
%
\NC = \NC \F{8} {-\log C} C^4
-\F{3} {2 \RB {-\log C}^2}
\RB {
  \lim_{x \to \infty} C ^x x ^{1/2} -2 C ^4
  -\F{1}{2} \int _{4} ^{\infty} C ^x x ^{-1/2} \Ss {d} x
} \NR
%
\NC = \NC \RB { \F{8} {-\log C} +\F{3} {\RB {-\log C}^2} } C^4
+\F{3} {4 \RB {-\log C}^2} \int _{4} ^{\infty} C ^x x ^{-1/2} \Ss {d} x \NR[+]
%
\NC \leq \NC \RB { \F{8} {-\log C} +\F{3} {\RB {-\log C}^2} } C^4
+\F{3} {8 \RB {-\log C}^2} \int _{4} ^{\infty} C ^x \Ss {d} x \NR[+]
%
\NC = \NC \RB { \F{8} {-\log C} +\F{3} {\RB {-\log C}^2} } C^4
-\F{3} {8 \RB {-\log C}^3} \RB {\lim_{x \to \infty} C ^x -C ^4} \NR
%
\NC = \NC \RB {
  \F{8} {-\log C}
  +\F{3} {\RB {-\log C}^2}

...
In bounding the higher moments of \m {\rho}, we may be more generous.
For \m {k =3, 4, 5, \dots},
...
Imitating the Markov inequality argument in classical probability, we have, by various result in previous subsections,
\Disp {
\NC \NC \MB{P} \SB {\rho \geq \RB {1 +\e} \MB{E} \SB {\rho}} \NR
\NC =\NC \MB{P} \SB {\Ss {e} ^{s_{+} \rho} \geq \Ss {e} ^{s_{+} \RB {1 +\e} \MB{E} \SB {\rho}}} \NR
\NC =\NC \Ss {e} ^{-s_{+} \RB {1 +\e} \MB{E} \SB {\rho}} \MB{E} \SB {\Ss {e} ^{s_{+} \rho}} \NR
\NC =\NC \Ss {e} ^{-s_{+} \RB {1 +\e} \MB{E} \SB {\rho}}
\RB {1 +\MB{E} \SB {\rho} +\F{1} {2} \MB{E} \SB {\rho^2} +\sum_{k=3}^\infty \F{1} {k!} \MB{E} \SB {\rho^k}} \NR
\NC =\NC \Ss {e} ^{-s_{+} \RB {1 +\e} \VNm {\V{u}} _2 ^2}
\RB {1 +\VNm {\V{u}} _2 ^2 +\F{1} {2} \RB {1 +N_Y^{-2}} \VNm {\V{u}} _2 ^4 +\sum_{k=3}^\infty \F{1} {k!} \MB{E} \SB {\rho^k}} \NR
}
for some \m {s_{+} >0}.
Of course, we have yet to justify the convergence of the formal power series.

Similarly, assuming convergence for a moment, for some \m {s_{-} >0}.
\Disp {
\NC \NC \MB{P} \SB {\rho \leq \RB {1 -\e} \MB{E} \SB {\rho}} \NR
\NC =\NC \Ss {e} ^{s_{-} \RB {1 -\e} \VNm {\V{u}} _2 ^2}
\RB {1 -\VNm {\V{u}} _2 ^2 +\F{1} {2} \RB {1 +N_Y^{-2}} \VNm {\V{u}} _2 ^4 +\sum_{k=3}^\infty \F{\RB {-1}^{k}} {k!} \MB{E} \SB {\rho^k}} \NR
}

...
{Lemma}
{
Let \m {\M{F}_R \in \MB {M}_{\MB {C}} \SB {N_H, N_R}} be generated randomly according to ().
Then, for any fixed \m {\V{u} \in \MB {V}_{\MB {C}} \SB {N_R}}, and for any \m {\e >0},
\Disp{
\NC \MB{P} _{\o_t}
\SB {
  \Nm {\VNm {\M{F}_R \V{u}} _2 ^2 -\VNm {\V{u}} _2 ^2}
  \geq \e \VNm {\V{u}} _2 ^2
}
\leq \NC \F {1} {2\e^2} \NR[+]
}

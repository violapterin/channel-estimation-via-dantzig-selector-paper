...
{
\Disp {
\NC \NC \MB{E} \SB {\M{F} \DB {n_H, n_Y} \M{F} \DB {n_H', n_Y'} \M{F} \DB {n_H, n_Y} \M{F} \DB {n_H, n_Y}} \NR
\NC = \NC \MB{E} \SB {\RB {\M{W}_B ^\Adj \M{W}_R ^\Adj} \DB {n_Y, n_H} \RB {\M{W}_B ^\Adj \M{W}_R ^\Adj} \DB {n_Y', n_H'}} \NR
\NC = \NC \i_2 \SB {n_H, n_H'} \D \i_2 \SB {n_Y, n_Y'} \D N_R \l_R^2 \l_B^2 \NR
}
}
...
\NC \NC \MB{E} \SB {\M{Q} \DB {n_Y, n_H} \M{Q} \DB {n_Y', n_H'}} \NR
\NC = \NC \startcases
N_R^2 \l_R^4 \l_B^4, \Q \MC n_Y =n_Y', n_H =n_H' \NR
0, \Q \NC \Rm {otherwise} \NR
\stopcases \NR
}
}
...
\Nm {\M{Q} \DB {n_y', n_h}} ^2
\Nm {\V{u} \DB{n_h}} ^4 \NR
\NC = \NC N_Y \D \F{1}{2} N_Y \RB{N_Y-1} \D 4 N_Y ^{-4} \VNm {\V{u}} _2 ^4 \NR
...
\Nm {\V{u} \DB{n_h}} ^2
\Nm {\V{u} \DB{n_h'}} ^2 \NR
\NC \leq \NC N_Y^2 \D \F{1}{2} N_H \RB{N_H-1} \D 4 N_Y ^{-4} \D \RB {\VNm {\V{u}} _2 ^4 -\VNm {\V{u}} _4 ^4} \NR
...
\Nm {\V{u} \DB{n_h}} ^2
\Nm {\V{u} \DB{n_h'}} ^2 \NR
\NC \leq \NC N_Y \D \F{1}{2} N_H \RB{N_H-1} \D 4 N_Y ^{-4} \D \RB {\VNm {\V{u}} _2 ^4 -\VNm {\V{u}} _4 ^4} \NR
\NC \leq \NC 4 N_H ^2 N_Y ^{-3} \VNm {\V{u}} _2 ^4 \NR[+]
}

The last one is more complicated.
We need a corollary that follows from ``Muirhead inequality''.
\Result
{Lemma}
{
...
\NC \leq \NC \RB {1/6} \RB {\VNm {\V{u}} _2 ^4 -\VNm {\V{u}} _4 ^4} \NR[+]
}
}
...
\NC = \sum _{
  ...
  \V{u} \DB{m_h}
  \V{u} \DB{m_h'} \NR
\NC =\NC N_Y \D \F{1}{2} N_H \RB{N_H-1} \D \F{1}{2} N_Y \RB{N_Y-1} \D N_H^2 \D 4 N_Y ^{-4} \NR
\NC \NC \SixQ
...
\Nm {\V{u} \DB{m_h}}
\Nm {\V{u} \DB{m_h'}} \NR
\NC \leq \NC \F{1}{3} N_Y ^{-1} N_H ^4 \VNm {\V{u}} _2 ^4. \NR[+]
}

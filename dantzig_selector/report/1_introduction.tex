...
\Disp {
\NC \NC \RB {1-\d_s} \VNm {\V {x}_{\MC {A}}}^2 \NR
\NC \leq \NC \VNm {\M{\Phi} \V {x}_{\MC {A}}} _2^2 \NR
\NC \leq \NC \RB {1+\d_s} \VNm {\V {x}_{\MC {A}}} _2^2 \NR[+]
}
}
...
\NC \Rm {subject} \; \Rm {to} \quad \MC \VNm {\M {\Phi}^\Adj \RB {\M {\Phi} \V {h}' -\V {y}}} _\infty \leq \g \NR
\stopcases \NR
}
\item Output \m {\V {h}}.
}
...
\NC \NC \quad \quad \quad \quad \quad \quad

...
In the transmitter end, there are (seeing towards receiver end), digital precoder \m {\M {F} _B \in \MB {C} ^{N_R \D N_Y}} and analog precoder \m {\M {F} _R \in \MB {C} ^{N_H \D  N_R}}.
Similarly, in the receiver end, there are (seeing towards transmitter end) digital combiner \m {\M {W} _R \in \MB {C} ^{N_R \D N_H}} and analog combiner \m {\M {W} _B \in \MB {C} ^{N_Y \D  N_R}}.

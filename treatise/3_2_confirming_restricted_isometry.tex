...
\m {\RB {\M {W} _B ^\Tr} _{\SB {n_Y, n_R}}} is set in an entirely analogous manner.
In addition, let \m {\RB {\M {F} _R} _{\SB {n_H, n_R}}} be uniformly distributed on the unit circle on the complex plane.
\m {\RB {\M {W} _R ^\Tr} _{\SB {n_Y, n_R}}} is set in an entirely analogous manner.
...
%
We want a large deviation result for i.i.d.\ sum of chi-square r.vs.
...
Here, we consult Haviv and Regev, \quotation {The restricted isometry property of subsampled Fourier matrices} collected in \cite [KlM17].

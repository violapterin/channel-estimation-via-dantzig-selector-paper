...
Let \m {\hat {\V {g}}} be the Dantzig Selector, and let the sparsity index \m {S} be fixed.
Split \m {\V {g}} into two parts: \m {\V {g} _{\SB{\MS {A}}}}, the largest \m {s} components of \m {\V {g}}, \m {\V {g} _{\SB{\MS {B}}}} the next \m {s} largest components of \m {\V {g}}, and \m {\V {g} _{\SB{\MS {C}}}} are the components complement to \m {\V {g} _{\SB{\MS {A}}}}.
For example, if \m {\V {g} =\IP {-1,3,-4,2,8}}, and \m {S=2}, then \m {\V {g} _{\SB{\MS {A}}} =\IP {0,3,0,0,8}}, \m {\V {g} _{\SB{\MS {B}}} =\IP {-1,0,0,2,0}}, and \m {\V {g} _{\SB{\MS {C}}} =\IP {-1,0,-4,2,0}}.
...
We define, similarly, \m {\V {a} _{\SB{\MS {A}}}} and \m {\V {a} _{\SB{\MS {C}}}}, with sparsity \m {s}, different from \m {S}.
...
Since it requires that the random variable shall have compact support, we truncate \m {\Nm {\a_l}} on \m {\Nm {\a_l} \leq 2}, on which there is 95 percent of the probability mass.
%

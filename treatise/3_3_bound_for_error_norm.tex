...
To show this, apply triangle inequality respectively on \m {\MS {A}} and \m {\MS {C}}, and recall that \m {\V {g} \eqsim \V {g} _{\SB{\MS {A}}}},
%
\DispNum {g:1:gd:g1} {
\NC \VNm {\V {g}} _1
...
{Proposition}
{
If \m {\M {Q}'} has \m {\d_{s'}} RIP, then, for \m {M=1,2,3,\dots} for which \m {\d _{Ms'}} is meaningful,
%
\DispNum {d:s:Md':d's} {
\NC \d_{Ms'}
\leq \NC \R {M} \d_{s'} \NR
...
Quoting previous results \Rf {1:p:2e:s4}, \Rf {1:p:ex:d's}, \Rf {d:1:dA:C1}, and \Rf {1:p:NH:H2}, we make some approximation and set
\DispNum {q:B:2e:Lp'} {
\NC q _{\Rm {iso}, B}

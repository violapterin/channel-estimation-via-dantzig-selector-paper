\startsection [title={Bound for the error norm}]
...
%
And our task is to bound the error norm \m {\VNm {\V {d}} _2}.

We argue that \m {\V {g}} can essentially be seen as sparse, and for that purpose we approximate irrelevent terms.
For example, we generously bound \m {\d_{S}} by \m {1}.
...
%
The propositions below are taken from \cite [CaT07] and modified slightly in accordance to our settings, except possibly the generalization to complex vector.
%
\Result
{Proposition}
{
...
%
To show this, observe that with triangle inequality applied respectively on \m {\MS {A}} and \m {\MS {C}}, while recalling that \m {\V {g} =\V {g} _{\SB{\MS {A}}}},
%
\DispNum {g:1:gd:g1} {
\NC \VNm {\V {g}} _1
...
We turn our attention to the next result, and fix an instance of \m {\M {P}} and instance of \m {\V {z}}.
We claim that
%
\DispNum {E:h:2N:Nh} {
...
%
Start with the fact that \m {\M {P} _{\SB {:, n_g}}} has unity \m {\ell_2}-norm, and on the randomness of \m {\V {z}}.
Now, the quantity \m {\Nm {\IP {\V {z} , \M {P} _{\SB {:, n_h}}}}} observes Standard Normal.
...
%
By power mean inequality, we get a statement cruder than \Rf {d:2:dA:12}, as below.
%
\Result
{Proposition}
{
...
%
The other quoted proposition reads
%
\DispNum {d:2:11:C1} {
...
Let \m {\M {Q}'} be fixed.
For all \m {s_1}-sparse \m {\V {x}_1}, for all \m {s_2}-sparse \m {\V {x}_2}, whose nonzero-positions are disjoint,
%
\DispNum {d:2:in:x2} {
\NC \T {\d} _{s_1, s_2}
= \NC \inf \CB {
...
%
So \Rf {d:2:11:C1} becomes the following:
%
\Result
{Proposition}
{
...
We are going to combine previous propositions and show the main result.
...
To prove this, we simplify the expression for \m {\VNm {\V {d} _{\SB{\MS {AB}}}} _2} in \Rf {d:2:11:C1} and the one for \m {\VNm {\V {d} _{\SB{\MS {C}}}} _1} in \Rf {d:1:dA:C1}.
...
%
And \Rf {d:2:11:C1} becomes the following:
%
\DispNum {d:2:16:H3} {
\NC \VNm {\V {d} _{\SB{\MS {AB}}}} _2
%

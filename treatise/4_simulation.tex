...
In the following, we plot the reciprocal of noise level vs relative error norm, for \m {N_H = 8, 12, 16, 20, 24} (from ``very small'' to ``very big''), respectively.
Plots 1 to 5 have \m {N_H = 3 N_Y} (``narrow''), and the plots 6 to 10 has \m {N_H = 2 N_Y} (``wide'').
%

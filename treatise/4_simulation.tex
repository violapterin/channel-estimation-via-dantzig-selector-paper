...
If OMP is even worse than LS, why was it adopted at all, in (say) Lee, Gil, and Lee \cite [LGL16]?
But our configuration may not be comparable to theirs, due to different design of beamformers, so it remains to see how do OMP and DS compare under their settings.

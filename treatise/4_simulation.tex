...
%
\blank [big]
\externalfigure [assorted-very-small-spectral.png] [wfactor=fit, hfactor=fit]
%
\blank [big]
...
%
\blank [big]
\externalfigure [assorted-very-big-spectral.png] [wfactor=fit, hfactor=fit]

For the plot of noise-to-signal vs time taken, we attach only one with \m {N_H = 18}, as an example.
%
\blank [big]

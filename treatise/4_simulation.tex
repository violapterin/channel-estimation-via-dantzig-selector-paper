...
\FigureCaption {Assorted methods, small, \m {N_H = 12, N_B = 12}, error norm.}
\blank [big]
%
\blank [big]
\externalfigure [assorted-square-medium-error.png] [wfactor=fit, hfactor=fit]
\FigureCaption {Assorted methods, medium, \m {N_H = 18, N_B = 18}, error norm.}
\blank [big]
%
\blank [big]
\externalfigure [assorted-square-big-error.png] [wfactor=fit, hfactor=fit]
\FigureCaption {Assorted methods, big, \m {N_H = 24, N_B = 24}, error norm.}
\blank [big]
%
\blank [big]
\externalfigure [assorted-narrow-small-error.png] [wfactor=fit, hfactor=fit]
\FigureCaption {Assorted methods, small, \m {N_H = 12, N_B = 10}, error norm.}
\blank [big]
%
\blank [big]
\externalfigure [assorted-narrow-medium-error.png] [wfactor=fit, hfactor=fit]
\FigureCaption {Assorted methods, medium, \m {N_H = 18, N_B = 15}, error norm.}
\blank [big]
%
\blank [big]
\externalfigure [assorted-narrow-big-error.png] [wfactor=fit, hfactor=fit]
\FigureCaption {Assorted methods, big, \m {N_H = 24, N_B = 20}, error norm.}
%
\blank [big]
\externalfigure [assorted-wide-small-error.png] [wfactor=fit, hfactor=fit]
\FigureCaption {Assorted methods, small, \m {N_H = 12, N_B = 8}, error norm.}
%
\blank [big]
\externalfigure [assorted-wide-medium-error.png] [wfactor=fit, hfactor=fit]
\FigureCaption {Assorted methods, medium, \m {N_H = 18, N_B = 12}, error norm.}
%
\blank [big]
\externalfigure [assorted-wide-big-error.png] [wfactor=fit, hfactor=fit]
\FigureCaption {Assorted methods, big, \m {N_H = 24, N_B = 16}, error norm.}
...
\FigureCaption {OMP, \m {N_H = N_B = 18}, time.}
\blank [big]

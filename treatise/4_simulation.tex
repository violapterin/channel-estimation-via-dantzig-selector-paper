...
Of course, we are not certain there is no method faster than Newton method, and implmentation details of CVXPY may change the conclusion too.
...
According to their analysis (eq.9.57), for most cases \m {-\log_2 \log_2 \e} can be bounded by \m {6}.

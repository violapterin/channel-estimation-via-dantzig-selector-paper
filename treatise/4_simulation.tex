...
The threshold used for the remainder norm used in OMP program, \m {\h_{\Rm {OMP}}}, is suggested in \cite [CaW11].
We take \m {2 \R {\log N_H}} for \m {\infty}-norm constraint, \m {\R {3 N_Y}} for 2-norm constraint.
...
We use the performance metric proposed in Lee, Gil, and Lee \cite [LGL16],
\DispNum {h:h:lo:vg} {
\NC \chi'
=\NC \RB {

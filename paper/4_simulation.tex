...
Taking log of \Rf {d-2-42-NH} we have
%
\Disp {
\NC \log \SB {7.85 \R {L} \RB {\log N_H}^3}
\lesssim \NC \F {1} {2} \log L +\F {3} {2} \log \log N_H +2.06 \NR
}
Thus we draw
\DispNum {h'-h-12-H2} {
\NC \h_{\Rm{th}}
...
\blank [big]
\externalfigure [big-assorted-abs.png] [wfactor=fit, hfactor=fit]

\blank [big]
\externalfigure [big-assorted-rel.png] [wfactor=fit, hfactor=fit]
...
%
\Disp {
\NC \MC {O} \SB {\VNm {\M {P} ^\Adj \V {z}} _{\SB {j}}}
= \NC \s \MC {O} \RB {1} \NR
}

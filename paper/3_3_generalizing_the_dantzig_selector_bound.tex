...
%
And our task is to bound the error norm \m {\VNm {\V {d}} _2}, where \m {\V {d} =\V {g} -\Hat {\V {g}}}.
...
Quoting previous results \Rf {1-p-2e-s4}, \Rf {P-d-eN-d4}, \Rf {1-p-ex-d's}, and \Rf {1-p-NH-H2}, we make some approximation and set
\DispNum {q-B-2e-Lp'} {
\NC q _{\Rm {iso}, B}

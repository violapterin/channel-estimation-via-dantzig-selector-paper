...
% Move `\hat` up
% Different font for `\mathcal` (`\definefallbackfamily`?)
...
\define [1] {\R} {{\sqrt {#1}}}
\define [1] {\T} {\tilde {\blackrule [width=0ex, height=1.7ex] #1}}
\define [1] {\Hat} {\hat {\blackrule [width=0ex, height=1.7ex] #1}}

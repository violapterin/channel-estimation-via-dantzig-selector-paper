...
\Disp{
\|d_{\MC{AB}}\|_2
\leq \F{1}{1-\d_{2L}} \|P_{\MC{A}\MC{B}}^\Tr P d\|_2 +\F{\d_{3L}}{(1-\d_{2L}) \R{L}} \|d_{C}\|_1
}
%
}
...
\Disp{
\|d\|_2
\leq \F{4 L^4}{\pi^4} \d_{3L}^4 (1-2\d_{2L}) ( \log N_H )^4
}
with overwhelming probability.
}
...
\Disp{
\|P_{\MC{A}\MC{B}}^\Tr P d\|_2
\leq &\|P^\Tr P d\|_2 \NT \\
\leq &\R{N_g} \|P^\Tr P d\|_\infty \NT \\
\leq &4 \R{ N_g \log N_g }
}
...
\| d_{A} \|_1
\leq &\R{L} \| d_{A} \|_2 \NT \\
\leq &\R{L} \| d_{\MC{AB}} \|_2 \NT \\
\leq &\F {\d_{3L}} {1-\d_{2L}} \| d_{\MC{C}} \|_1 +\F {4} {1-\d_{2L}} \R{L N_g \log N_g} 
}

As the next step, we must eliminate \(\|d_{\MC{A}}\|_1\) in rhs of Lemma ().
\Disp{
\| d_{\MC{C}} \|_1
\leq &\| d_{\MC{A}} \|_1 +2 \| g_{\MC{C}} \|_1 \NT \\
\leq &\F {\d_{3L}} {1-\d_{2L}} \| d_{\MC{C}} \|_1
+2 \| g_{\MC{C}} \|_1
...
\Disp{
\| d_{\MC{C}} \|_1
\leq &2 \F{1-\d_{2L}} {1 -\d_{2L} -\d_{3L}} \| g_{\MC{C}} \|_1
...
\Disp{
\| d \|_2^2
\leq &\|d_{\MC{A}\MC{B}}\|_2^2 +\F{1}{L} \|d_{\MC{C}}\|_1^2 \NT \\
\leq & \left( \F{\d_{3L}^2} {L^2 (1-\d_{2L})^2} +\F{1}{L} \right) \|d_{\MC{C}}\|_1^2
+\F{8 \d_{3L}} {L (1-\d_{2L})^2} \R{N_g \log N_g} \|d_{\MC{C}}\|_1 \NT \\

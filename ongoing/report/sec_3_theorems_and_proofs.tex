...
\Disp{
|S \RB{x} \DB{n_1}| \geq &|S \RB{x} \DB{n_2}|, \\
n_1 >&n_2,
\quad n_1, n_2 \in T\RB{N} \NT
}
...
\Disp{
D (\f')
:=&\Nm{ \sum_{n=0}^{N_H-1} \RM{e}^{i n \f'} } \NT \\
=&\F{|\sin (N_H \f'/2)|}{|\sin (\f' /2)|}, \\
\quad 0 \leq& \f' \leq \pi \NT
}
%
...
\Disp{
\RB{ \M{K}^\H \V{a}(\f) } \DB{ k }
=\F{1}{N_H} D \RB{ \f -\F{2 \pi k} {N_H} }
}
So we need only bound
\Disp{
R(\eta)
:=\F{1}{N_H} \sum_{n_H =s}^{N_H -1} D \RB{ \eta +\F{2 \pi n_H} {N_H} }
}
...
\Disp{
1 -2 \RB{ \F{12}{\d} }^s \exp \left[ - \RB{ \F{\epsilon^2}{4} -\F{\epsilon^3}{6} } \F{\d}{2} N_p \right]
}
}
...
\leq & \RB{ \F{\d_{3L}^2} {L^2 (1-\d_{2L})^2} +\F{1}{L} } \|\V{d}_{\MC{C}}\|_1^2

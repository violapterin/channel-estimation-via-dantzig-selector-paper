...
\Disp{
H
=\sum_{l=1}^L \alpha_l \V{a} \left( \F{d} {\lambda} \sin \varphi_l' \right) \V{a} \left( \F{d_{\RM{arr}}} {\lambda} \sin \vartheta_l' \right)^\H
}
%
...
\Disp{
\varphi_l
=\F{d_{\RM{arr}}} {\lambda} \sin \varphi_l' \\
\vartheta_l
=\F{d_{\RM{arr}}} {\lambda} \sin \vartheta_l'
}
%
...
\M{K} (n_1, n_2) =&\F{1} {\sqrt{N_h}} \RM{e}^{2\pi i n_1 n_2 /N_h}, \\

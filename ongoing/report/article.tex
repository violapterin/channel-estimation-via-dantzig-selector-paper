...
{Proposition}
{
Let \(h \in \mathbb{R}^n\) and \(\eta \in \mathbb{R}^p\) are defined as in ().
Then
\begin{align}
\|d_{BC}\|_1
\leq \|d_A\|_1 +\|g_{BC}\|_1
...
\begin{align}
\|g\|_1 -\|d_A\|_1 +\|d_{BC}\|_1 -\|g_{BC}\|_1
\leq& \|g +d\|_1 \\ \notag
\leq& \|g\|_1
\end{align}
In the first line, we recall \(g =g_A\).

\Result
{Lemma}
{
\begin{align}
|\langle e, P_{:,j} \rangle| \leq \sqrt{2 \log p}
\end{align}
}
...
\begin{align}
\langle e -r, P_{:,j} \rangle
=\langle P \hat{g} -P g, P_{:,j} \rangle
=\langle P g, P_{:,j} \rangle
\end{align}
...
\begin{align}
\|d_A\|_2
\leq \frac{1}{1-\delta} \|P^\dagger_{AB} P \eta\|_2 +\frac{\theta}{(1-\delta) \sqrt{L}} \|d_{BC}\|_1
\end{align}
}
...
\begin{align}
\|d\|_2^2
\leq \|d_{AB}\|_2^2 +\frac{1}{L} \|d_C\|_1^2
\end{align}
}

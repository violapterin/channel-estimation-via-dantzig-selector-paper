...
\newcommand{\chref}[1]{Chapter~\eqref{ch:#1}}
\newcommand{\secref}[1]{Section~\eqref{sec:#1}}
\newcommand{\figref}[1]{Figure~\eqref{fig:#1}}
\newcommand{\tabref}[1]{Table~\eqref{tab:#1}}
\newcommand{\eqnref}[1]{\eqref{eq:#1}}
\newcommand{\thmref}[1]{Theorem~\eqref{#1}}
\newcommand{\prgref}[1]{Program~\eqref{#1}}
\newcommand{\algref}[1]{Algorithm~\eqref{#1}}
\newcommand{\clmref}[1]{Claim~\eqref{#1}}
\newcommand{\lemref}[1]{Lemma~\eqref{#1}}
\newcommand{\ptyref}[1]{Property~\eqref{#1}}

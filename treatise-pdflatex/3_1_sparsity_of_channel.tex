...
=\VNm {\RB {\M {K}^\dagger \V {a} \SB {\f}} _{\SB{\mathscr {C}}}} _2 ^2 \NR
}
%
Let \m {\f} be fixed.
...
\DispNum {D:y':nH:Hy'} {
D \SB {\psi'}
:= \sum_{n_H=0}^{N_H-1} \mathsf {e}^{i n_H \psi'} \NR
}
%
And
%
...
\DispNum {K:H:1N:nH} {
\V {b} \SB {\f} _{\SB {n_H}}
=\frac {1} {N_H} D \SB {\psi \SB {\f, n_H}} \NR
}
...
\DispNum {D:y':si:y'p'} {
\Nm {D \SB {\psi'}}
= \frac {\Nm {\sin \SB {N_H \psi'/2}}} {\Nm {\sin \SB {\psi' /2}}} \NR
%
\leq B \SB {\psi'} \NR
%
:= \frac {48} {\Nm {\psi'^2 -24} \Nm {\psi'}}, \NR
%
- \pi \leq \psi' < \pi. \NR
}
%
...
\DispNum {b:1:1N:NH} {
\VNm {\V {b} \SB {\f} _{\SB{\mathscr {C}}}} _1
\leq \frac {1} {N_H} \D \frac {N_H} {2\pi} \D 2 \int_{\pi s/N_H}^{\pi} B \SB {\psi'} ^2 d \psi' \NR
%
= \frac {48} {N_H \pi^3}
\int _{s /N_H} ^1 \frac {1} {\RB {24/\pi^2 -x'^2} ^2 x'^2} dx' \NR
%
=\frac {1} {\pi} \log \frac {N_H^2 /s^2 - \pi^2 /24} {1 - \pi^2 /24} \NR
%
\eqsim \frac {2} {\pi} \RB {\log N_H - \log s} \NR
%
\leq \frac {2} {\pi} \log N_H \NR
}
%

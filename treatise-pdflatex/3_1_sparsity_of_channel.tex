...
\DispNum {D:y':nH:Hy'} {
D \SB {\psi'}
:= \sum_{n_H=0}^{N-1} \mathsf {e}^{i n_H \psi'} 
}
%
And
%
...
%
= &\frac {1} {\pi} \log \frac {N^2 /s^2 - \pi^2 /24} {1 - \pi^2 /24} \notag \\
%
\eqsim &\frac {2} {\pi} \RB {\log N - \log s} \notag \\
%
\leq &\frac {2} {\pi} \log N 
}
%
...
%
\leq 
&\frac {4} {\pi^2} L \RB {\log N_{H,t}} \RB {\log N_{H,r}} \D
...
Now we have
\DispNum {g:2:12:43} {
\frac {\VNm {\M {g} _{\SB{\mathcal {C}}}} _1} {\RB {\log N_{H,t}} \RB {\log N_{H,r}}}
...
{Proposition}
{
Let \m {\V {g} \in \mathbb {C} ^{N_{H,t} \D N_{H,r}}} be defined as in \eqref {g:g:ve:Nh}.
Then the bound
%
\DispNum {g:C:4p':NH} {
\VNm {\M {g} _{\SB{\mathcal {C}}}} _1
\leq \frac {4} {3} \RB {\log N_{H,t}} \RB {\log N_{H,r}} 
}
%

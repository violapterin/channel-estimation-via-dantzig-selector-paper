...
%
\DispNum {P:x:ex:ex} {
\NC \mathbb {P} \SB {\VNm {\M {W} _B \V {u}} _2 ^2 \geq 1 + 2 \R {\frac {x} {N_B}} + \frac {2x} {N_B}}
\leq \NC \mathsf {e} ^{-x} \NR
}
%
and the lower tail inequality
%
\DispNum {P:x:ex:ex!} {
\NC \mathbb {P} \SB {\VNm {\M {W} _B \V {u}} _2 ^2 \leq 1 - 2 \R {\frac {x} {N_B}}}
\leq \NC \mathsf {e} ^{-x} \NR
}
%
...
\DispNum {1:p:2e:s4} {
\NC 1 -p
\leq \NC 2 \mathsf {e} ^{-N_B \R {\d_s} /4} \NR
}
}
...
\DispNum {N:R:sd':NH} {
\NC N_R
\geq \NC \frac {s} {\d_s^2} \RB {\log \F{1}{\d_s}}^2 \RB {\log \F{s}{\d_s}}^2 \log N_H \NR
}
%
...
\DispNum {P:2:FB:WR} {
\NC \VNm {P} _2
=\NC \VNm {\M {F}_B^\intercal \M {F}_B^\Tr} _2 \VNm {\M {W}_B \M {W}_R} _2 \NR
}
...
\DispNum {G:G:Ud:dU} {
\NC \M {G}
=\NC \M {U} \mathrm {diag} \SB {\V {d}'} \M {U} ^\dagger \NR
}
for some \m {S}-sparse \m {\V {d}'} and unitary \m {\M {U}}.
Clearly,
\DispNum {G:2:g2:g2} {
\NC \VNm {\M {G}} _2
\NC =\VNm {\mathrm {abs} \SB {\V {g}}} _2 \NR
}

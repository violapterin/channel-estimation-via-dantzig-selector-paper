...
In the transmitter end, there are (seeing towards the receiver end), digital precoder \m {\M {F} _B \in \mathbb {C} ^{N_R \D N_{B,t}}} and analog precoder \m {\M {F} _R \in \mathbb {C} ^{N_H \D  N_R}}.
Similarly, in the receiver end, there are (seeing towards the transmitter end) digital combiner \m {\M {W} _R \in \mathbb {C} ^{N_R \D N_H}} and analog combiner \m {\M {W} _B \in \mathbb {C} ^{N_{B,r} \D  N_R}}.
...
Since we restrict our discussion to a short interval of time, the noise term may be simply taken as a matrix \m {\M {Z} \in \mathbb {C} ^{N_{B,r} \D N_{B,r}}} with each entry being i.i.d.\ standard normal.
...
\in \mathbb {C} ^{N_{B,t} \D N_{B,r} \D N_H^2} 
}
%
and
%

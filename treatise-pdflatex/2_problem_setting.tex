...
\V {a} \SB { 2\pi \frac {d_{\mathrm {arr}}} {\l _{\mathrm {arr}}} \sin \th_l', N_{H,r}}^\dagger 
}
%
...
\in \mathbb {C} ^{N_B N_B \D N_{H,t} N_{H,r}} 
}
%
...
%
\DispNum {K:K:CN:H1} {
\M {K} \in &\mathbb {C} ^{N_{H,t} \D N_{H,r}} \notag \\
%
\M {K} _{\SB {n_1, n_2}} \SB {N}
...
%
\item Input \m {\M {F} _B \in \mathbb {C} ^{N_{R,t} \D N_B}},
\m {\M {F} _R \in \mathbb {C} ^{N_{H,t} \D N_R}},
\m {\M {W} _R \in \mathbb {C} ^{N_{R,r} \D N_{H,r}}},
\m {\M {W} _B \in \mathbb {C} ^{N_B \D N_{R,r}}},
and \m {\M {Y} \in \mathbb {C} ^{N_B \D N_B}}.
%
\item Find \m {\M {P} \in \mathbb {C} ^{N_B N_B \D N_{H,t} N_{H,r}}}, \m {\V {y} \in \mathbb {C} ^{N_{H,t} N_{H,r}}} as in above.
%

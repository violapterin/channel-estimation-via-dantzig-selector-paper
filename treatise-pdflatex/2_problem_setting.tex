...
In the transmitter end, there are (seeing towards the receiver end), the digital precoder \m {\M {F} _B \in \mathbb {C} ^{N_{B,t} \D N_{B,t}}} and the analog precoder \m {\M {F} _R \in \mathbb {C} ^{N_H \D N_{B,t}}}.
Similarly, in the receiver end, there are (seeing towards the transmitter end) the digital combiner \m {\M {W} _B \in \mathbb {C} ^{N_{B,r} \D N_{B,r}}} and the analog combiner \m {\M {W} _R \in \mathbb {C} ^{N_{B,r} \D N_H}}.

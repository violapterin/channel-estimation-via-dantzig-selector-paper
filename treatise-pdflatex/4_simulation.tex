...
For Lasso, \m {\g _{\mathrm {Lasso}}} (or \m {\l _{\mathrm {Lasso}}}) is also crucial to the performance, but cannot be obtained in advance.
Thus, for sake of comparison, we set the same threshold for Lasso and DS.
In view of the fact that \m {\VNm {g} _1 \leq 2 N_{H,t} N_{H,r} \VNm {g} _\infty}, we tentatively set \m {\l _{\mathrm {DS}} =  2 N_{H,t} N_{H,r} / \g _{\mathrm {DS}}} and \m {\l _{\mathrm {Lasso}} =  1 / \g _{\mathrm {Lasso}}}.
...
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-square-six-usual.png}
\caption {\m {N_B = 4, N_{H,t} = 16, N_{H,r} = 12}, with \m {6} stages, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-wide-six-usual.png}
\caption {\m {N_B = 4, N_{H,t} = 16, N_{H,r} = 12}, with \m {6} stages, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-tall-six-usual.png}
\caption {\m {N_B = 4, N_{H,t} = 12, N_{H,r} = 16}, with \m {6} stages, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-small-square-six-usual.png}
\caption {\m {N_B = 2, N_{H,t} = 6, N_{H,r} = 6}, with \m {6} stages, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-small-wide-six-usual.png}
\caption {\m {N_B = 2, N_{H,t} = 8, N_{H,r} = 6}, with \m {6} stages, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-small-tall-six-usual.png}
\caption {\m {N_B = 2, N_{H,t} = 6, N_{H,r} = 8}, with \m {6} stages, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-big-square-six-usual.png}
\caption {\m {N_B = 6, N_{H,t} = 18, N_{H,r} = 18}, with \m {6} stages, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-big-wide-six-usual.png}
\caption {\m {N_B = 6, N_{H,t} = 24, N_{H,r} = 18}, with \m {6} stages, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-big-tall-six-usual.png}
...
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-square-three-usual.png}
\caption {\m {N_B = 4, N_{H,t} = 16, N_{H,r} = 12}, with \m {3} stages, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-wide-three-usual.png}
\caption {\m {N_B = 4, N_{H,t} = 16, N_{H,r} = 12}, with \m {3} stages, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-tall-three-usual.png}
...
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-square-six-oommpp.png}
\caption {\m {N_B = 4, N_{H,t} = 16, N_{H,r} = 12}, with \m {6} stages, different thresholds of OMP, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-wide-six-oommpp.png}
\caption {\m {N_B = 4, N_{H,t} = 16, N_{H,r} = 12}, with \m {6} stages, different thresholds of OMP, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-tall-six-oommpp.png}
\caption {\m {N_B = 4, N_{H,t} = 12, N_{H,r} = 16}, with \m {6} stages, different thresholds of OMP, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-square-six-lasso.png}
\caption {\m {N_B = 4, N_{H,t} = 16, N_{H,r} = 12}, with \m {6} stages, different thresholds of Lasso, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-wide-six-lasso.png}
\caption {\m {N_B = 4, N_{H,t} = 16, N_{H,r} = 12}, with \m {6} stages, different thresholds of Lasso, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-tall-six-lasso.png}
\caption {\m {N_B = 4, N_{H,t} = 12, N_{H,r} = 16}, with \m {6} stages, different thresholds of Lasso, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-square-six-ddss.png}
\caption {\m {N_B = 4, N_{H,t} = 16, N_{H,r} = 12}, with \m {6} stages, different thresholds of DS, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-wide-six-ddss.png}
\caption {\m {N_B = 4, N_{H,t} = 16, N_{H,r} = 12}, with \m {6} stages, different thresholds of DS, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {error-medium-tall-six-ddss.png}
...
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {time-medium-square-six-usual.png}
\caption {\m {N_B = 4, N_{H,t} = 12, N_{H,r} = 12}, with \m {6} stages, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {time-small-square-six-usual.png}
\caption {\m {N_B = 2, N_{H,t} = 6, N_{H,r} = 6}, with \m {6} stages, error.}
\end {figure}
%
\begin {figure} [H]
\includegraphics [width = \textwidth] {time-big-square-six-usual.png}
\caption {\m {N_B = 6, N_{H,t} = 18, N_{H,r} = 18}, with \m {6} stages, error.}
\end {figure}

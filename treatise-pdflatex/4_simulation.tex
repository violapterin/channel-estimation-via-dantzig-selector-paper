...
\mathscr {R} \SB {\V {x}}
\in \mathbb {R} ^{2M} \NR
\mathscr {R} \SB {\V {x}} _{\SB {m}}
= \startcases
\mathfrak {Re} \SB {\V {x} _{\SB {m'}}}, \MC m =2m' \NR
\mathfrak {Im} \SB {\V {x} _{\SB {m'}}}, \MC m =2m'+1 \NR
\stopcases \NR
m' 
=  0, 1, 2, \ldots, M-1 \NR
}
...
%
\DispNum {R:1:x::x:} {
\mathscr {R} ^{-1} \SB {\mathscr {R} \SB {\V {x}}}
=\V {x} \NR
}
%
...
\DispNum {R:A:R2:21} {
\mathscr {R} \SB {\M {A}}
\in \mathbb {R} ^{2M_1 \D 2M_2} \NR
\mathscr {R} \SB {\M {A}} _{\SB {m_1,m_2}} =
\startcases
\mathfrak {Re} \SB {\M {A} _{\SB {m_1',m_2'}}}, \MC \RB {m_1, m_2} = \RB {2m_1', 2m_2'} \NR
\mathfrak {Im} \SB {\M {A} _{\SB {m_1',m_2'}}}, \MC \RB {m_1, m_2} = \RB {2m_1'+1, 2m_2'} \NR
-\mathfrak {Im} \SB {\M {A} _{\SB {m_1',m_2'}}}, \MC \RB {m_1, m_2} = \RB {2m_1', 2m_2'+1} \NR
\mathfrak {Re} \SB {\M {A} _{\SB {m_1',m_2'}}}, \MC \RB {m_1, m_2} = \RB {2m_1'+1, 2m_2'+1} \NR
\stopcases \NR
m_1 
...
\leftarrow \startcases
   \Min {\tilde {\V {g}}', \tilde {\V {f}}'}  \MC \IP {\V {1}, \tilde {\V {f}}'} \NR
   \mathrm {subject} \; \mathrm {to} \MC \tilde {\V {g}}' \preceq \tilde {\V {f}}' \NR
   \MC - \tilde {\V {g}}' \preceq \tilde {\V {f}}' \NR
   \MC \tilde {\M {P}}^\dagger \tilde {\M {P}} \tilde {\V {g}}' \preceq \tilde {\M {P}}^\dagger \tilde {\V {y}} + \g_{\mathsf {DS}} \V {1} \NR
   \MC - \tilde {\M {P}}^\dagger \tilde {\M {P}} \tilde {\V {g}}' \preceq - \tilde {\M {P}}^\dagger \tilde {\V {y}} + \g_{\mathsf {DS}} \V {1} \NR
\stopcases \NR
}
\item Convert
...
\DispNum {g:::R1:1g} {
\Hat{\V {g}}
\leftarrow \mathscr {R} ^{-1} \SB {\Hat{\T{\V {g}}}} \NR
}
\item Calculate
%
\DispNum {G:G:ve:1g} {
\hat {G}
\leftarrow \mathrm {vec}^{-1} \SB {\hat {g}} \NR
}
\item Calculate
%
\DispNum {H:H:KG:GK} {
...
=2 N_H^2, \NR
N_2
=\lfloor 4 \log N_H \rfloor, \NR
N_1
=\lfloor \R {N_0 N_2} \rfloor \NR
}
...
\V {g}_0
=\V {g}_{\mathrm {LS}} \NR
= \RB {\M {P} ^\dagger \M {P}} ^{-1} \M {P} ^\dagger \V {y} \NR
}
%
...
\DispNum {C:S:Og:g1} {
C_{\mathrm {DS}}
=\mathscr {O} \SB {\VNm {\V {g}_{\mathrm {LS}} -\V {g} ^\star} _1} N_H^4 \NR
}
%
Also assume
%
...
=\mathscr {O} \SB {
   ...
   -\V {g}} _1} N_H^4 \NR
=\mathscr {O} \SB {\VNm {\M {P} ^\dagger \V {z}} _1} N_H^4 \NR
}
...
%
\DispNum {O:j:sO:O1} {
\mathscr {O} \SB {\VNm {\M {P} ^\dagger \V {z}} _{\SB {j}}}
= \s \mathscr {O} \RB {1} \NR
}
Then we simply have
%
...
\DispNum {t:P:NH:83} {
\tilde {t}_{\mathrm {OMP}} \eqsim \mathscr {O} \SB {N_H^{3.6}} \NR
\tilde {t}_{\mathrm {Lasso}} \eqsim \mathscr {O} \SB {N_H^{4.8}} \NR
\tilde {t}_{\mathrm {DS}} \eqsim \mathscr {O} \SB {N_H^{8.3}} \NR
}

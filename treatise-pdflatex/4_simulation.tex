...
In this chapter we shall compare \eqref {d:2:OL:H3} with numerical experiments.
...
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {assorted-square-small-error.png}
\caption {Assorted methods, \m {N_B = 12, N_H = 12}, error norm.}
\end {figure}
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {assorted-square-medium-error.png}
\caption {Assorted methods, \m {N_B = 18, N_H = 18}, error norm.}
\end {figure}
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {assorted-square-big-error.png}
\caption {Assorted methods, \m {N_B = 24, N_H = 24}, error norm.}
\end {figure}
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {assorted-narrow-small-error.png}
\caption {Assorted methods, \m {N_B = 10, N_H = 12}, error norm.}
\end {figure}
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {assorted-narrow-medium-error.png}
\caption {Assorted methods, \m {N_B = 15, N_H = 18}, error norm.}
\end {figure}
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {assorted-narrow-big-error.png}
\caption {Assorted methods, \m {N_B = 20, N_H = 24}, error norm.}
\end {figure}
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {assorted-wide-small-error.png}
\caption {Assorted methods, \m {N_B = 8, N_H = 12}, error norm.}
\end {figure}
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {assorted-wide-medium-error.png}
\caption {Assorted methods, \m {N_B = 12, N_H = 18}, error norm.}
\end {figure}
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {assorted-wide-big-error.png}
...
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {assorted-narrow-medium-time.png}
...
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {ddss-narrow-small-error.png}
\caption {DS, \m {N_B = 10, N_H = 12}, error.}
\end {figure}
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {ddss-narrow-medium-error.png}
\caption {DS, \m {N_B = 15, N_H = 18}, error.}
\end {figure}
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {ddss-narrow-big-error.png}
...
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {ddss-narrow-medium-time.png}
...
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {oommpp-square-small-error.png}
\caption {OMP, \m {N_H = 12, N_B = 12}, error.}
\end {figure}
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {oommpp-square-medium-error.png}
\caption {OMP, \m {N_H = 18, N_B = 18}, error.}
\end {figure}
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {oommpp-square-big-error.png}
...
%
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {oommpp-square-medium-time.png}
...
\bigskip
\begin {figure} [hbt]
\includegraphics [width = \textwidth] {scatter-ddss-failure.png}
...
\includegraphics [width = \textwidth] {scatter-ddss-success.png}
\end {figure}
\bigskip

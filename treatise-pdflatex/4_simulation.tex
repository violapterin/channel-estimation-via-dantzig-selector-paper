...
= \s N_{H,t} N_{H,r} \mathcal {O} \RB {1} 
}
Then we simply have
%
\DispNum {C:S:ON:H6} {
C_{\mathrm {DS}}
=\mathcal {O} \SB {N_{H,t} ^3 N_{H,r} ^3} 
}
...
However, Lasso and DS are equivalent in certain conditions \cite {AsR10}, and we may suppose here they have the same complexity, \m {\mathcal {O} \SB {N_{H,t} ^3 N_{H,r} ^3}}.

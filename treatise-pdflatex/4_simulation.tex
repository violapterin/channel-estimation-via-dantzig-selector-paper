...
\caption {\m {N_{B,t} = 3, N_{B,r} = 2, N_H = 12}, with \m {4} stages, error.}
\end {figure}
...
\DispNum {C:P:ON:NY} {
C_{\mathrm {OMP}}
=\mathcal {O} \SB {N_H^2 \log \R {N_{B,t} N_{B,r}}} 
}
%
Here \m {\log N_{B,t}, \log N_{B,r}} are small in our experiments, and if we drop them we may assume \m {\mathcal {O} \SB {N_H^2}}.

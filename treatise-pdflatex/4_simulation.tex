...
\DispNum {g:::R1:1g} {
\Hat{\V {g}}
\leftarrow \mathscr {R} ^{-1} \SB {\Hat{\T{\V {g}}}} \\
}
\item Calculate
%
\DispNum {G:G:ve:1g} {
...
\DispNum {C:S:Og:g1} {
C_{\mathrm {DS}}
=\mathscr {O} \SB {\VNm {\V {g}_{\mathrm {LS}} -\V {g} ^\star} _1} N_H^4 \\
}
%
Also assume
%
...
=\mathscr {O} \SB {
   ...
   -\V {g}} _1} N_H^4 \\
=\mathscr {O} \SB {\VNm {\M {P} ^\dagger \V {z}} _1} N_H^4 \\
}
...
\DispNum {t:P:NH:83} {
\tilde {t}_{\mathrm {OMP}} \eqsim \mathscr {O} \SB {N_H^{3.6}} \\
\tilde {t}_{\mathrm {Lasso}} \eqsim \mathscr {O} \SB {N_H^{4.8}} \\
\tilde {t}_{\mathrm {DS}} \eqsim \mathscr {O} \SB {N_H^{8.3}} \\
}

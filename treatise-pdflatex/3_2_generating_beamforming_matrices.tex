...
\VNm {\M {F} _B \V {u}} _2
=\R {
   \sum _{i=0} ^{N_{R,t}-1} \VNm {\sum _{j=0} ^{N_B-1} \frac {1} {\R{N_B}} \chi _{i,j} \V {u} _{j}} _2 ^2} 
}
%
...
By some calculation, we have the upper tail inequality (respectively for \m {N_{R,r}})
%
\DispNum {P:x:ex:ex} {
\mathbb {P} \SB {\VNm {\M {F} _B \V {u}} _2 ^2 \geq 1 + 2 \R {\frac {x} {N_{R,t}}} + \frac {2x} {N_{R,t}}}
\leq \mathsf {e} ^{-x} 
}
%
...
%
\DispNum {P:x:ex:ex!} {
\mathbb {P} \SB {\VNm {\M {F} _B \V {u}} _2 ^2 \leq 1 - 2 \R {\frac {x} {N_{R,t}}}}
\leq \mathsf {e} ^{-x} 
}
%

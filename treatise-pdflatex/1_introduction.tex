...
\Disp {
\V {x}  _{\SB {\mathscr {A}}}
=\sum _{i \in \mathscr {A}} \V {v} \V {u} _{i} \NR
%
\M {Q}  _{\SB {\mathscr {A}}}
=\sum _{i \in \mathscr {A}} \M {Q} _{\SB {:,i}} \NR
}
%
...
\leq \VNm {\M {Q} \V {x}} _2 ^2 \NR
%
\leq \RB {1+\d_s} \VNm {\V {x}} _2 ^2 \NR
}
}
%
...
\Min {\V {h}'} \MC \VNm {\V {h}'} _1 \NR
%
\mathrm {subject} \; \mathrm {to} \quad \MC \VNm {\M {Q}^\dagger \RB {\M {Q} \V {h}' -\V {y}}} _\infty \leq \g \NR
\stopcases \NR
}
...
\DispNum {Q:Q:QS:Qy} {
\M {Q} ^\ddagger
\leftarrow \RB {\M {Q} _{\SB {S}} ^\dagger \M {Q} _{\SB {S}}} ^{-1} \M {Q} _{\SB {S}} ^\dagger \NR
%
\V {r}
\leftarrow \V {y} -\M {Q} _{\SB {S}} ^\dagger \M {Q} ^\ddagger \V {y} \NR
}
%
\item Break if
%

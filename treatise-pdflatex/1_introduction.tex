...
It appears that, for a given number of sampling, DS recovers more successfully than OMP.
...
Second, with the further constraint of hybrid beamforming, it is unclear whether their guarantee theorem for recovery is still valid.

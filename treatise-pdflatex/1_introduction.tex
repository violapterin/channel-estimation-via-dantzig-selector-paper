...
\Disp {
\NC \V {x}  _{\SB {\mathscr {A}}}
=\NC \sum _{i \in \mathscr {A}} \V {v} \V {u} _{i} \NR
%
\NC \M {Q}  _{\SB {\mathscr {A}}}
=\NC \sum _{i \in \mathscr {A}} \M {Q} _{\SB {:,i}} \NR
}
%
...
%
\NC \mathrm {subject} \; \mathrm {to} \quad \MC \VNm {\M {Q}^\dagger \RB {\M {Q} \V {h}' -\V {y}}} _\infty \leq \g \NR
\stopcases \NR
}
...
\DispNum {n:n:n0:nr} {
\NC n
\leftarrow \NC \underset {n' =0, \dots, N_p-1} {\mathrm {argmax}}
...
\DispNum {Q:Q:QS:Qy} {
\NC \M {Q} ^\ddagger
\leftarrow \NC \RB {\M {Q} _{\SB {S}} ^\dagger \M {Q} _{\SB {S}}} ^{-1} \M {Q} _{\SB {S}} ^\dagger \NR
%
\NC \V {r}
\leftarrow \NC \V {y} -\M {Q} _{\SB {S}} ^\dagger \M {Q} ^\ddagger \V {y} \NR
}
%
\item Break if
%
...
\DispNum {g:g:Qy:Qy} {
\NC \hat {\V {g}}
\leftarrow \NC \M {Q} ^\ddagger \V {y} \NR
}
\stopitemize
}
%

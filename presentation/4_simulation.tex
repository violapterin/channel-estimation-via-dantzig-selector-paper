...
% XXX % % XXX % % XXX % % XXX % % XXX % % XXX %
\Frame {\m {1/\s} vs \m {\chi}, OMP only, \m {N_H=24=3N_Y}}
{
\blank [big]
\externalfigure [oommpp-medium-error.png] [width=11cm]
}
% XXX % % XXX % % XXX % % XXX % % XXX % % XXX %
\Frame {\m {1/\s} vs \m {\chi}, DS only, \m {N_H=24=3N_Y}}
{
\blank [big]
\externalfigure [ddss-medium-error.png] [width=11cm]
}
% XXX % % XXX % % XXX % % XXX % % XXX % % XXX %

...
\DispNum {D:y':nH:Hy'} {
\NC D \SB {\psi'}
:= \NC \sum_{n_H=0}^{N-1} \Ss {e}^{i n_H \psi'} \NR
}
%
And
%
...
\DispNum {D:y':si:y'p'} {
\NC \Nm {D \SB {\psi'}}
= \NC \F {\Nm {\sin \SB {N \psi'/2}}} {\Nm {\sin \SB {\psi' /2}}} \NR
%
...
We are going to bound the rectangles by an integral, where we have to split the cases that \m {N} is odd and even.
%
\DispNum {b:1:1N:NH} {
\NC \VNm {\V {b} \SB {\f} _{\SB{\MS {C}}}} _1
\leq \NC \F {1} {N} \D \F {N} {2\pi} \D 2 \int_{\pi s/N}^{\pi} B \SB {\psi'} ^2 d \psi' \NR
%
\NC = \NC \F {48} {N \pi^3}
\int _{s /N} ^1 \F {1} {\RB {24/\pi^2 -x'^2} ^2 x'^2} dx' \NR
%
\NC =\NC \F {1} {\pi} \log \F {N^2 /s^2 - \pi^2 /24} {1 - \pi^2 /24} \NR
%
\NC \eqsim \NC \F {2} {\pi} \RB {\log N - \log s} \NR
%
\NC \leq \NC \F {2} {\pi} \log N \NR
}
%
...
%
\NC \leq \NC
\F {4} {\pi^2} L \RB {\log N_{H,t}} \RB {\log N_{H,r}} \D
...
Now we have
\DispNum {g:2:12:43} {
\NC \F {\VNm {\M {g} _{\SB{\MS {C}}}} _1} {L \RB {\log N_{H,t}} \RB {\log N_{H,r}}}
\leq \NC \F {16 \R{2}} {\pi ^{5/2}}
\leq \F {4} {3}. \NR
}
%
...
{Proposition}
{
Let \m {\V {g} \in \MB {C} ^{N_{H,t} \D N_{H,r}}} be defined as in \Rf {g:g:ve:Nh}.
Then the bound
%
\DispNum {g:C:4p':NH} {
\NC \VNm {\M {g} _{\SB{\MS {C}}}} _1
\leq \NC \F {1} {3} L \RB {\log N_{H,t} + \log N_{H,r}} ^2 \NR
}
%

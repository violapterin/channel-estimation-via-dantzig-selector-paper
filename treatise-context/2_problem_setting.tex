...
In the transmitter end, there are (seeing towards the receiver end), digital precoder \m {\M {F} _B \in \MB {C} ^{N_R \D N_B}} and analog precoder \m {\M {F} _R \in \MB {C} ^{N_H \D  N_R}}.
Similarly, in the receiver end, there are (seeing towards the transmitter end) digital combiner \m {\M {W} _R \in \MB {C} ^{N_R \D N_H}} and analog combiner \m {\M {W} _B \in \MB {C} ^{N_B \D  N_R}}.

...
Third, when \m {N_{B,t} /N_{B,r}} is smaller, \m {\T {\chi} _{\Rm {DS}}} is smaller, because we have a higher sample rate.
As \m {N_{B,t} /N_{B,r}} increase for given \m {\s}, \m {\T {\chi} _{\Rm {DS}}} improves more significantly.

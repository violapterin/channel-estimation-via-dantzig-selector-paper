...
We have tried \m {\l = N_H^2 / \g_{\Rm {DS}}} in the simulation.
...
The number of paths \m {L = NN_HH /2}.
...
We take \m {\h_{\Rm {OMP}} = 2 \R {\log N_H}} for \m {\infty}-norm condition, \m {\h_{\Rm {OMP}} = \R {3 \R {N_{B,r} N_{B,t}}}} for 2-norm condition.
